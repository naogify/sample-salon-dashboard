...
export default function PosPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 lg:h-[calc(100vh-64px-48px)]">
      ...
      <div className="flex-[0.8] bg-muted/30 rounded-xl p-4 border border-border min-h-[400px] lg:min-h-0">
